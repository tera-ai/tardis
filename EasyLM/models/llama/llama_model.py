...
from mlxu import load_pickle
from mlxu import open_file
...
from EasyLM.bpt import blockwise_ffn
from EasyLM.jax_utils import get_gradient_checkpoint_policy
...
LLAMA_STANDARD_CONFIGS = {
    'vqlm_language_base': {
        # TODO: change vocab_size whenever we change our data tokenizer pipeline
        'vocab_size': 29163,  # 8192 vq tokens + 20k metadata/action tokens (for the toy data)
        'hidden_size': 768,
    ...
    'vqlm_100m': {
        # TODO: change vocab_size whenever we change our data tokenizer pipeline
        'vocab_size': 29163,  # 8K vq tokens + 100 special tokens
        'hidden_size': 640,
    ...
    'vqlm_2b': {
        'vocab_size': 29163,
        'hidden_size': 2816,        # Scaled up from 2048
        'intermediate_size': 7680,  # ~2.7 × 2816
        'num_hidden_layers': 22,    # Same as 1b
        'num_attention_heads': 16,  # Same as 1b
